...
//        private DepartmentService depRepo;
//        private PatientService patRepo;
//        private InstituteService instRepo;
//
//        public PatientService getPatRepo() {
//            return patRepo;
//        }
//
//        public InstituteService getInstRepo() {
//            return instRepo;
//        }
//
//        public DepartmentService getDepRepo() {
//            return depRepo;
//        }
//
//        public ParseXml() {
//            this.depRepo = new DepartmentService();
//            this.patRepo = new PatientService();
//            this.instRepo = new InstituteService();
//        }
//
...
//        }
//
//        DepartmentService getDeps(XMLEventReader reader, java.lang.String tag) throws XMLStreamException {
//
//            DepartmentEntity tempDep = null;
//            DepartmentService tempDepRep = new DepartmentService();
//
//            while (reader.hasNext()) {
//                XMLEvent nextEvent = reader.nextEvent();
//                switch (nextEvent.getEventType()) {
...
//        }
//
//        InstituteService saveInstitutesToRepository(InstituteService tempRep, Institute temp, java.lang.String endelementName,
...
//        }
//
//        InstituteService getInst(XMLEventReader reader, java.lang.String tag) throws XMLStreamException {
//
//            Institute tempInst = null;
//            InstituteService tempInstReptempInstRep = new InstituteService();
//
//            while (reader.hasNext()) {
//                XMLEvent nextEvent = reader.nextEvent();
//                switch (nextEvent.getEventType()) {
